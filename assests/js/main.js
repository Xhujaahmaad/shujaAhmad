...
!(function ($, e, t, a) {
  var r = (function () {
    ...
    s = {
      latinPunctuation:
        "Ã¢â‚¬â€œÃ¢â‚¬â€Ã¢â‚¬Â²Ã¢â‚¬â„¢'Ã¢â‚¬Å“Ã¢â‚¬Â³Ã¢â‚¬Å¾\"(Ã‚Â«.Ã¢â‚¬Â¦Ã‚Â¡Ã‚Â¿Ã¢â‚¬Â²Ã¢â‚¬â„¢'Ã¢â‚¬ÂÃ¢â‚¬Â³Ã¢â‚¬Å“\")Ã‚Â».Ã¢â‚¬Â¦!?",
      latinLetters:
        "\\u0041-\\u005A\\u0061-\\u007A\\u00C0-\\u017F\\u0100-\\u01FF\\u0180-\\u027F",
    },
    l = {
  ...
  ($.fn[i] = function (d) {
    ...
    function u(e, a) {
      ...
      return (
        a.aria && r.setAttribute("aria-hidden", "true"),
    ...
    if (
      m.search.length &&
      ("string" == typeof m.search || /^\d/.test(parseFloat(m.search)))
    )
      ...
      switch (
        ("string" == typeof m.delimiter &&
          (m.delimiter = m.delimiter.toLowerCase()),
        m.delimiter)
      ) {
        case "all":
          h = /(.)/;
        ...
        case "sentence":
          h =
            /(?=\S)(([.]{2,})?[^!?]+?([.Ã¢â‚¬Â¦!?]+|(?=\s+$)|$)(\s*[Ã¢â‚¬Â²Ã¢â‚¬â„¢'Ã¢â‚¬ÂÃ¢â‚¬Â³Ã¢â‚¬Å“")Ã‚Â»]+)*)/;
          break;
        case "element":
          h = /(?=\S)([\S\s]*\S)/;
          break;
        ...
        if (d !== !1) {
          (f = {
            ...
            e.data(i) === a ||
              ...
              (p(e, m),
              m.debug && n.log(i + ": Removed element's existing Blast call.")),
          ...
          try {
            ...
            (m.tag = "span"),
              m.debug &&
                n.log(i + ": Invalid tag supplied. Defaulting to span.");
          }
          e.addClass(i + "-root"),
            m.debug && n.time(i),
            g(this, m),
...
setTimeout(function () {
  ...
  $(".text-zone .blast").mouseenter(function () {
    var el = $(this);
...
$(window).scroll(function () {
  var sectionOffset = $(".work-experience-section").offset().top;
  var scrollPosition = $(window).scrollTop();

  if (scrollPosition >= sectionOffset) {
    $(".right-content, .background-gradient-fix").fadeOut(250);
  } else {
    $(".right-content, .background-gradient-fix").fadeIn(250);
  }
});
...
$(document).ready(function () {
  ...
  $(window).on("load", function () {
    if ($(window).scrollTop() >= sectionOffset - windowHeight) {
      $(".right-content, .background-gradient-fix").fadeOut(250);
    } else {
      $(".right-content, .background-gradient-fix").fadeIn(250);
    }
...
$(".mbtn.mbtn-cl, .move-to-section-btn").click(function () {
